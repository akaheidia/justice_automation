...
reports_tree_reports_node = "xpath://span[@id='rdDmtCaption' and text()='Reports']"
reports_tree_expand_reports_icon = "xpath://span[@id='rdDmtCaption' and text()='Reports']/../..//td[@id='rdImage']/img[contains(@src, 'rdArrowRight')]"
reports_tree_collapse_reports_icon = "xpath://span[@id='rdDmtCaption' and text()='Reports']/../..//td[@id='rdImage']/img[contains(@src, 'rdArrowDown')]"
reports_tree_site_node = "xpath://span[@id='rdDmtCaption' and text()='Site']"
reports_tree_expand_site_icon = "xpath://span[@id='rdDmtCaption' and text()='Site']/../..//td[@id='rdImage']/img[contains(@src, 'rdArrowRight')]"
reports_tree_collapse_site_icon = "xpath://span[@id='rdDmtCaption' and text()='Site']/../..//td[@id='rdImage']/img[contains(@src, 'rdArrowDown')]"
reports_tree_topn_node = "xpath://span[@id='rdDmtCaption' and text()='Top N']"
reports_tree_expand_topn_icon = "xpath://span[@id='rdDmtCaption' and text()='Top N']/../..//td[@id='rdImage']/img[contains(@src, 'rdArrowRight')]"
reports_tree_collapse_topn_icon = "xpath://span[@id='rdDmtCaption' and text()='Top N']/../..//td[@id='rdImage']/img[contains(@src, 'rdArrowDown')]"
reports_tree_analytics_node = "xpath://span[@id='rdDmtCaption' and text()='Analytics']"
reports_tree_expand_analytics_icon = "xpath://span[@id='rdDmtCaption' and text()='Analytics']/../..//td[@id='rdImage']/img[contains(@src, 'rdArrowRight')]"
reports_tree_collapse_analytics_icon = "xpath://span[@id='rdDmtCaption' and text()='Analytics']/../..//td[@id='rdImage']/img[contains(@src, 'rdArrowDown')]"
...
reports_site_cpu_utilization_menu = "xpath://span[@id='rdDmtCaption' and text()='CPU Utilization']"
reports_site_memory_utilization_menu = "xpath://span[@id='rdDmtCaption' and text()='Memory Utilization']"
reports_site_port_utilization_menu = "xpath://span[@id='rdDmtCaption' and text()='Port Utilization']"
reports_site_port_error_menu = "xpath://span[@id='rdDmtCaption' and text()='Port Error']"
...
reports_topn_cpu_utilization_menu = "xpath://span[@id='rdDmtCaption' and text()='Top N']//following::span[@id='rdDmtCaption' and text()='CPU Utilization']"
reports_topn_memory_utilization_menu = "xpath://span[@id='rdDmtCaption' and text()='Top N']//following::span[@id='rdDmtCaption' and text()='Memory Utilization']"
reports_topn_port_utilization_menu = "xpath://span[@id='rdDmtCaption' and text()='Top N']//following::span[@id='rdDmtCaption' and text()='Port Utilization']"
reports_topn_port_error_menu = "xpath://span[@id='rdDmtCaption' and text()='Top N']//following::span[@id='rdDmtCaption' and text()='Port Error']"
