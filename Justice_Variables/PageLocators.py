...
reports_tree_expand_sites_icon = "xpath://span[@id='rdDmtCaption' and contains(text(),'Sites')]/../..//td[@id='rdImage']/img[contains(@src, 'rdArrowRight')]"
reports_tree_collapse_sites_icon = "xpath://span[@id='rdDmtCaption' and contains(text(),'Sites')]/../..//td[@id='rdImage']/img[contains(@src, 'rdArrowDown')]"
...
reports_topn_cpu_utilization_menu = "xpath://span[@id='rdDmtCaption' and contains(text(),'CPU Utilization')]"
reports_topn_memory_utilization_menu = "xpath://span[@id='rdDmtCaption' and contains(text(),'Memory Utilization')]"
reports_topn_port_utilization_menu = "xpath://span[@id='rdDmtCaption' and contains(text(),'Port Utilization')]"
reports_topn_port_error_menu = "xpath://span[@id='rdDmtCaption' and contains(text(),'Port Error')]"
...
reports_topn_top_aps_by_clients_page_title = "xpath://h2[contains(text(),'Wireless Clients')]"
